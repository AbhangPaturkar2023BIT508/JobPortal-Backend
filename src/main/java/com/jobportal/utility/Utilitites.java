...
public class Utilitites {
	...
	@Autowired
	public void setMonogOperation(MongoOperations mongoOperation) {
		Utilitites.mongoOperation = mongoOperation;
	}
	public static Long getNextSequence(String key) throws JobPortalException {
		...
		if(seq == null)throw new JobPortalException("Unalbe to get sequence id for key : "+key);
		return seq.getSeq();
	}
